...
class PrepareGameScreenTest {
  ...
  fun clickingOnBlack_ChangesColorToBlack() {
    ...
    assert(state.colorChoice == ColorChoice.Black)
  }
  ...
  fun clickingOnWhite_ChangesColorToWhite() {
    ...
    assert(state.colorChoice == ColorChoice.White)
  }
