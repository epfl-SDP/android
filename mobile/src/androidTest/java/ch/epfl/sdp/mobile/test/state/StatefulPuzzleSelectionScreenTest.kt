...
class StatefulPuzzleSelectionScreenTest {
  ...
  @Test
  fun given_statefulPuzzleSelectionScreen_when_itIsDisplayedWithBlackPuzzlePieces_then_ExpectedPuzzlesAreDisplayed() =
      runTest {
    val auth = emptyAuth()
    ...
    rule.onNodeWithText("009tE", substring = true).assertExists() // black pawn
    rule.onNodeWithText("005N7", substring = true).assertExists() // black knight
    rule.onNodeWithText("008Nz", substring = true).assertExists() // black bishop
  ...
  @Test
  fun given_statefulPuzzleSelectionScreen_when_itIsDisplayedWithWhitePuzzlePieces_then_ExpectedPuzzlesAreDisplayed() =
    runTest {
      val auth = emptyAuth()
      val store = emptyStore()
      val assets =
      ...
      rule.onNodeWithText("003nQ", substring = true).assertExists() // white rook
      rule.onNodeWithText("009Os", substring = true).assertExists() // white queen
      rule.onNodeWithText("00C7m", substring = true).assertExists() // white king
    }
