...
package ch.epfl.sdp.mobile.androidTest.ui.screenshots.matchers

import android.graphics.Color
import androidx.annotation.FloatRange
import ch.epfl.sdp.mobile.androidTest.ui.screenshots.BitmapMatcher
import ch.epfl.sdp.mobile.androidTest.ui.screenshots.MatchResult
...
class MSSIMMatcher(@FloatRange(from = 0.0, to = 1.0) private val threshold: Double = 0.98) :
  ...
  override fun compareBitmaps(
    ...
    val stats = "[MSSIM] Required SSIM: $threshold, Actual " + "SSIM: " + "%.3f".format(SSIMTotal)
