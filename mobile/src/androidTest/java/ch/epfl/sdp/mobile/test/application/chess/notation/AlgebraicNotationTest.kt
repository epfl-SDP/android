...
class AlgebraicNotationTest {
  ...
  @Test
  fun given_foolsMate_when_encodingThenDecodingInAlgebraicNotation_then_hasGoodBoard() {
  ...
  @Test
  fun given_staleMate_when_encodingThenDecodingInAlgebraicNotation_then_hasGoodBoard() {
