 ...
 * @return chess keyword string after applying all speechRules, or an empty string if all rules fail
 *//*
 ...
 *//*
   ...
   */
/**
 * Detects if any word in the speech is within the pieceDictionary and return its equivalent correct
 * chess piece keyword
 ...
 * @param detectionBlock a detection method for a certain type of chess keyword (ChessPiece | Number
 * |Letter)
