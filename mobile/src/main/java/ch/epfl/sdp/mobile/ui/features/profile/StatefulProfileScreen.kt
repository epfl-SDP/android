...
import ch.epfl.sdp.mobile.data.features.authentication.AutenticatedUserProfileScreenState
...
fun StatefulProfileScreen(
  ...
  val state = remember(user) { AutenticatedUserProfileScreenState(user) }
